...
# Load spaCy German model (or 'en_core_web_sm' for English)
...
def upload():
    ...
    fields = get_field_list()
    return render_template("objekt_form.html", fields=fields, data=data, colors=colors, name_entities=name_entities)

@app.route('/extract_entities', methods=['POST'])
def extract_entities():
    """Read all form text, extract named entities, and highlight fields"""
    fields = get_field_list()
    data = {}
    colors = {}
    name_entities = {}
